...
public class DroolsBeanFactory {
	...
	public KieSession getKieSession() {
		...
		// Release if needed for kie service to pull modules/rule engine for specific
		// versions
		ReleaseId krDefaultReleaseId = kieServices.getRepository().getDefaultReleaseId();

		// Create container/runtime for rule execution. This will act as kie session
		// factory
	...
	private KieFileSystem getKieFileSystem() {
		...
		// kieFileSystem - Represents a virtual file system where Drools resources, such
		// as rule files (DRL files), are stored.
